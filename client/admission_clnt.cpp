...
public:
    ...
    bool requestAdmission(const string &imsi, const int32_t gnb, const float sinr);
...
bool AdmissionClientImpl::requestAdmission(const string &imsi, const int32_t gnb, const float sinr)
{
